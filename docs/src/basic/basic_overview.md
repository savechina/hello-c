...
| [运算符与表达式](./operators.md) | 算术、关系、逻辑运算符 | 🟢 简单 | 25 分钟 |
...
| 章节 | 说明 | 难度 | 预计时间 |
|------|------|------|---------|
| [指针](./pointers.md) | 🔗 [5 个子章节](#指针子章节) | 🟡 中等 | 3.5 小时 |
| [字符串](./strings.md) | 🔗 [4 个子章节](#字符串子章节) | 🟡 中等 | 2.5 小时 |
| [结构体](./structs.md) | 🔗 [5 个子章节](#结构体子章节) | 🟡 中等 | 2.5 小时 |
...
| [结构体内存布局](./struct_memory_layout.md) | padding、alignment、sizeof、位域、序列化 | 🔴 |
...
- **[高级进阶](../advance/overview.md)** — 深入学习 C 的高级特性：
  - 数据结构（链表、树、哈希表）
  - 网络编程（Socket、TCP/UDP）
  - 多线程编程（POSIX Threads）
  - 跨平台开发
